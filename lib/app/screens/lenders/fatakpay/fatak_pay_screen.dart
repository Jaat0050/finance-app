...
import 'package:mitra_fintech_agent/app/screens/lenders/fatakpay/fatakpay_offer.dart';
...
class FatakPayScreen extends StatefulWidget {
  String type;
  String pin;
  String amount;
  String imgUrl;
  ...
  @override
  State<FatakPayScreen> createState() => _FatakPayScreenState();
}

class _FatakPayScreenState extends State<FatakPayScreen> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //-------------------------------------email-------------------------------------------------
                fieldName('Customer Email address'),
                textField(_emailController, 'Enter Customer email', false,
                    false, false),
                ...
                dropDownBuilder('Select one', _employmentTypeController,
                    professionType, professionValue),

                //--------------------------------------------------------------------------------------
                fieldName('Loan Amount'),
                textField(
                    _amountController, 'Enter amount', false, false, true),

                //-------------------------------------pan-------------------------------------------------
                fieldName('Customer Pan Card Number'),
                textField(
                    _panController, 'Enter Customer Pan', false, true, false),

                //--------------------------------------------------------------------------------------
                GestureDetector(
                    onTap: () {}, child: fieldName('Residence Pincode')),
                textField(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isLoading
                        ...
                        : () async {
                            if (_firstNameController.text.isEmpty) {
                            ...
                            } else if (_employmentTypeController.text.isEmpty) {
                              toastMsg("Please Select Gender");
                              ...
                              var eligibilityResponse = await apiValue.fatakPay(
                              ...
                              if (eligibilityResponse != null) {
                                if (eligibilityResponse['status'] ==
                                  ...
                                  // String responseConvenienceFee =
                                  //     eligibilityResponse['data'][0]
                                  //             ['convenience_fees']
                                  //         .toString();

                                  String responseMaxEligibilityAmount =
                                      eligibilityResponse['data'][0]
                                              ['max_eligibility_amount']
                                          .toString();

                                  String responseProcessingFee =
                                      eligibilityResponse['data'][0]
                                              ['processing_fees']
                                          .toString();

                                  // String responseTenure =
                                  //     eligibilityResponse['data'][0]['max_interest']
                                  //         .toString();

                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FatakPayOffer(
                                        askedAmount: widget.amount,
                                        // convenienceFee: responseConvenienceFee,
                                        maxEligibilityAmount:
                                            responseMaxEligibilityAmount,
                                        message: responseMessage,
                                        processingFee: responseProcessingFee,
                                        // tenure: responseTenure,
                                        mailID: widget.mail,
      ...
      child: TextField(
        ...
        keyboardType: isDateSelection
            ...
            : isNumber
                ...
                : TextInputType.text,
        showCursor: !isDateSelection ? true : false,
        readOnly: !isDateSelection ? false : true,
        inputFormatters: ispan ? [LengthLimitingTextInputFormatter(10)] : [],
        onChanged: ispan
            ? (text) {
